// using the provided grid, find the greatest product of 4 adjacent #s in any direction
public class Problem11 {
    ...
    public static void main(String[] args) {
        ...
        String[] s = new String[20];
            ...
            for (int i = 0; i < 20; i++) {
            for (int j = 0; j < 20; j++) {
                A[i][j] = Integer.parseInt(s[i].substring(3*j, 3*j + 2));
            }
        }
        ...
        for (int i = 0; i <= 16; i++) {
            for (int j = 0; j < 20; j++) {
                int a = A[i][j] * A[i + 1][j] * A[i + 2][j] * A[i+3][j];
                if (a > maxProduct) maxProduct = a;
            }
        }
        for (int j = 0; j <= 16; j++) {
            for (int i = 0; i < 20; i++) {
                int a = A[i][j] * A[i][j+1] * A[i][j+2] * A[i][j+3];
                if (a > maxProduct) maxProduct = a;
            }
        }
        ...
        for (int i = 0; i <= 16; i++) {
            for (int j = 0; j <= 16; j++) {
                int a = A[i][j] * A[i + 1][j+1] * A[i + 2][j+2] * A[i+3][j+3];
                if (a > maxProduct) maxProduct = a;
            }
        }
